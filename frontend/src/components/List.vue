<template>
    <div class="list">
        <div class="justify-content-between row">
            ...
            <button v-if="this.$store.getters['todos/getChanges'].length" @click="this.$store.dispatch('todos/resetAllChanges')">Сбросить изменения</button>
            <button v-if="this.$store.getters['todos/getChanges'].length" @click="this.$store.dispatch('todos/save')">Сохранить все изменения ({{$store.getters['todos/unconfirmed'].length}})</button>
